...
#else
// Stub for when cuDNN is not available
inline int convert_trt2cudnn_dtype(nvinfer1::DataType trt_dtype, void* cudnn_dtype) {
    (void)trt_dtype;
    (void)cudnn_dtype;
    return 0;  // Return error since cuDNN is not available
}
#endif
